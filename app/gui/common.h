...
/* Apply common text-label styling: width, alignment, font and colour. */
 ...
 * UI_TEMP_ENABLE_DECIMALS, UI_TEMP_FIXED_UNIT).  color and font are applied
 * to every label. */
